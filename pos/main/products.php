...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;color:rgb(255, 95, 66); font:bold 22px 'Aleo';" /><i class="icon-plus-sign icon-large"></i> Add Product </button></a><br><br>
<?php } ?>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="8%"> Total </th>
			<?php if($_SESSION['SESS_MEMBER_ROLE'] == "owner" or ($_SESSION['SESS_MEMBER_ROLE'] == 'admin')) { ?>
	...
	<tbody>
		   ...
		   <?php if($_SESSION['SESS_MEMBER_ROLE'] == "owner" or ($_SESSION['SESS_MEMBER_ROLE'] == 'admin')) { ?> 
			<td>
				<a rel="facebox" href="share.php?id=<?php echo $row['product_id']; ?>"  title="Click to share the item" ><button class="btn btn-warning btn-mini" value="<?php echo $id; ?>"><i class="icon-share"></i>share</button></a>
				<a rel="facebox" title="Click to return to supplier" href="return.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-user"></i>return</button> </a>
			</td>
			<?php } ?>
			</tr>
			<?php
