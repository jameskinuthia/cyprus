...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('db.php');
				$result = $db->prepare("SELECT * FROM $ep ORDER BY id DESC");
				$result->execute();
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a rel="facebox" title="Click to edit the employee" href="editemployee.php?id=<?php echo $row['id']; ?>"><button class="btn btn-mini btn-warning"><i class="icon-edit"></i> Edit</button> </a> <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click to Delete the employee"><button class="btn btn-mini btn-danger"><i class="icon-trash"></i> Delete</button></a></td>
			</tr>
			<?php
				}
			?>
