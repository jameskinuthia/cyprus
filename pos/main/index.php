...
<?php include('navfixed.php');?>
	<?php
$position=$_SESSION['SESS_MEMBER_ROLE'];
...
?>
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Backend
			</div>
			<ul class="breadcrumb">
			<li class="active"></li>
			</ul>
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Cyprus pos
			</center></font>
<div id="mainmain">
