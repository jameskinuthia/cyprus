...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="products.php"><i class="icon-list-alt icon-2x"></i> Product</a>                                     </li>
	...
	<div class="contentheader">
			<i class="icon-group"></i>  Goods Suppliers
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active"> Goods Suppliers</li>
			</ul>
...
<?php 
			...
			Total Number of  Goods Suppliers: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Search  Goods Supplier..." autocomplete="off" />
<?php if(($_SESSION['SESS_MEMBER_ROLE'] == 'admin') or ($_SESSION['SESS_MEMBER_ROLE'] == 'owner')) { ?>
<a rel="facebox" href="addsupplier.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add  Goods Supplier</button></a><br><br>
<?php } ?>
