...
<div id="login"  style="height: 250px !important">
<div class="errorMsg">
	<button id='closeErrors'>&times;</button>
	<?php
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>POINT OF SALE </center></font>
			enter your email if position is owner
		<br>

<div class="input-prepend">
		<span style="height:30px; width:25px;" class="add-on"><i class="icon-group icon-2x"></i></span>
		<select style="height:40px;" type="text" name="role" >
